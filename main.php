...
/// Let's break down the request like I broke down when I saw the error logs.
...
switch ($_SERVER['REQUEST_METHOD']) {
    ...
    case 'PUT': // HANGANG DYAN KANALANG SA ID ANG HIRAP SA NAME AT LAST NAME
        if ($req[0] == 'Update') {
